...
export const ReadingsModel = connectProductionMongo.model<IControllerReadings>("ControllerReadings", readingsModel);
export const LocalReadingsModel = connectLocationMongo.model<IControllerReadings>("ControllerReadings", readingsModel);
